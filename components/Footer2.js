                                        ...
                                        <div className="tm-modern-heading">
                                          <div className="heading-primary-wrap">
                                            <div className="heading-primary elementor-heading-title">
                                              VMS transforms lives through accessible, student-centered, high-quality
                                              education and meets learners&apos; needs for a lifetime.
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                  ...
                                  <div className="elementor-widget-wrap">
                                    ...
                                    >
                                      <div className="elementor-widget-container">
                                        <div className="tm-modern-heading">
                                          <div className="heading-primary-wrap">
                                            <h4 className="heading-primary elementor-heading-title">Get in touch</h4>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="elementor-widget-wrap">
                                    ...
                                    >
                                      <div className="elementor-widget-container">
                                        <div className="tm-modern-heading">
                                          <div className="heading-primary-wrap">
                                            <h4 className="heading-primary elementor-heading-title">Links</h4>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
