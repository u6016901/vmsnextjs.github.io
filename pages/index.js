                                          ...
                                          <div className="tm-modern-heading">
                                            <div className="heading-primary-wrap">
                                              <h2 className="heading-primary elementor-heading-title">
                                                Investing In <mark>Knowledge</mark> in
                                              </h2>
                                              <p></p>
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <div className="unicamp-box">
                                                                  <Link href="/news">
                                                                    <a className="event-image unicamp-image">
                                                                      <img
                                                                      ...
                                                                      <Link href="/news">
                                                                        <a className="event-image unicamp-image">
                                                                          <img
                                                                            ...
                                                                            width={480}
                                                                          />{" "}
                                                                          The Role of Conflict in a Political Account of
                                                                          Common Goods
                                                                        </a>
                                                                      </Link>
                                                                    </h3>
                                                                    ...
                                                                    <h3 className="event-title post-title-2-rows">
                                                                      <Link href="/news">
                                                                        <a className="link-in-title">
                                                                          Ethics in AI Live Event: Machines Judging
                                                                          Humans
                                                                        </a>
                                                                      </Link>
                                                                    </h3>
