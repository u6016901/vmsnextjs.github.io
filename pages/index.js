                          ...
                          <div id="page-navigation" className="navigation page-navigation">
                            <nav id="menu" className="menu menu--primary">
                              <ul
                                ...
                                data-smartmenus-id={16502317500842585}
                              >
                                ...
                                <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-45 level-1">
                                  ...
                                  >
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1782">
                                      ...
                                      <div className="menu-item-wrap">
                                        <span className="menu-item-title">Intelligent Systems Research Laboratory</span>
                                      </div>
                                    </li>
              ...
              <div className="row">
                <div id="page-main-content" className="page-main-content">
                  <div className="rich-snippet display-none">
                    <h1 className="entry-title">VMS-Home</h1> <span className="published">April 5, 2021</span>
                    <span className="updated" data-time="2021-05-04 9:16">
                      2021-05-04 9:16
                    </span>
                  </div>
                  <article id="post-2837" className="post-2837 page type-page status-publish hentry post-no-thumbnail">
                                          ...
                                          <div className="tm-modern-heading">
                                            <div className="heading-primary-wrap">
                                              <h2 className="heading-primary elementor-heading-title">
                                                Raise Your
                                                <p><mark>Standard</mark> in</p> 
                                              </h2>
                                              <p></p>
                                              <h2 className="heading-primary elementor-heading-title">VMS</h2>
                                              <p />
                                            </div>
                                          </div>
                                        </div>
                                                          ...
                                                          <div className="unicamp-graphic-content icon-box-content">
                                                            <div className="heading-wrap">
                                                              <h3 className="heading">
                                                                Welcome to Vincent Mary School Of Science And
                                                                Technology!
                                                              </h3>
                                                            ...
                                                            <div className="description-wrap">
                                                              <div className="description">
                                                                <p>
                                                                  The Vincent Mary School of Science and Technology is
                                                                  one of the pioneers to develop information technology.
                                                                  This tradition helps in creating graduates who are
                                                                  experts in the science and technology field, as well
                                                                  as fluent English speakers.
                                                                </p>
                                                              </div>
                                                            </div>
                                                          </div>
                                                      ...
                                                      <a className="tm-cover-image-box unicamp-box style-03 link-secret">
                                                        <div className="content-wrap">
                                                          <div className="unicamp-image image">
                                                            <img
                                                              src="https://raw.githubusercontent.com/u6016901/vms2022.github.io/main/pictures/home-06-intro-bg-01.jpg"
                                        ...
                                        <div className="elementor-widget-container">
                                          <div className="tm-icon-box unicamp-box has-link">
                                            <div className="unicamp-graphic-box icon-box-wrapper">
                                              <div className="unicamp-graphic-content icon-box-content">
                                                <div className="heading-wrap">
                                                  <h3 className="heading">Apply for Admissions</h3>
                                                  <div className="heading-divider" />
                                                </div>
                                                <div className="description-wrap">
                                                  <div className="description">
                                                    At VMS we don&apos;t expect intelligence to come in any particular
                                                    shape or form. We&apos;re looking for future students who are
                                                    inquisitive, passionate, original and determined to grow.{" "}
                                                  </div>
                                                </div>
                                                <div className="tm-button-wrapper">
                                                  <a
                                                      ...
                                                      >
                                                        <div className="unicamp-graphic-content counter-content">
                                                          <div className="counter-number-wrap">
                                                            ...
                                                            <span className="counter-number">990</span>
                                                            <span className="counter-number-suffix" />
                                                          </div>
                                                          <div className="heading-wrap">
                                                            <h3 className="counter-heading">Students</h3>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
                                                    ...
                                                    <div className="elementor-widget-container">
                                                      ...
                                                      >
                                                        <div className="unicamp-graphic-content counter-content">
                                                          ...
                                                          <div className="heading-wrap">
                                                            <h3 className="counter-heading">Nationalities</h3>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
                                                    ...
                                                    <div className="elementor-widget-container">
                                                      ...
                                                      >
                                                        <div className="unicamp-graphic-content counter-content">
                                                          ...
                                                          <div className="heading-wrap">
                                                            <h3 className="counter-heading">International Students</h3>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
                                                      ...
                                                      <div className="tm-modern-heading">
                                                        ...
                                                        <div className="heading-description-wrap">
                                                          <div className="heading-description">
                                                            <p className="p1">
                                                              <span className="s1">
                                                                What&apos;s happening in VMS. Explore Your Potential
                                                                &amp; Talents in VMS
                                                              </span>
                                                            </p>
                                                          </div>
                                                        ...
                                                        <div className="swiper-inner">
                                                          <div className="swiper-container swiper-container-initialized swiper-container-horizontal">
                                                            <div
                                                              ...
                                                              style={{
                                                                transform: "translate3d(-803px, 0px, 0px)",
                                                                  ...
                                                                  <div className="post-caption">
                                                                    <div className="post-categories">
                                                                      ...
                                                                      <a rel="category tag">
                                                                        ...
                                                                        />
                                                                        <span className="cat-name">Student life</span>
                                                                      </a>
                                                                    </div>
                                                                    <h3 className="post-title post-title-2-rows">
                                                                      <Link href="/news">
                                                                ...
                                                                <div className="post-wrapper unicamp-box">
                                                                  ...
                                                                  <div className="post-caption">
                                                                    ...
                                                                    <h3 className="post-title post-title-2-rows">
                                                                      <Link href="/posts">
                                                                        <a>
                                                                          Your subjects are fun to learn, A.Chayapol!!!
                                                                        </a>
                                                                      </Link>
                                                                    </h3>
                                                                    <div className="post-meta">
                                                          ...
                                                          <div className="swiper-nav-buttons-wrap">
                                                            <div className="swiper-nav-buttons">
                                                              ...
                                                              >
                                                                ...
                                                                <span className="nav-button-text">Prev</span>
                                                              </div>
                                                              <div
    ...
    <div className="elementor-row">
          ...
          <div className="elementor-widget-wrap">
            ...
            >
              <div className="elementor-container elementor-column-gap-extended">
                <div className="elementor-row">
                  <div
                    className="elementor-column elementor-col-66 elementor-inner-column elementor-element elementor-element-5affd59 animated unicampFadeInUp"
                    data-id="5affd59"
                    data-element_type="column"
                  ...
                  >
                    <div className="elementor-column-wrap elementor-element-populated">
                      <div className="elementor-widget-wrap">
                        <div
                          className="elementor-element elementor-element-767d1e4 elementor-align-right elementor-mobile-align-left elementor-widget elementor-widget-tm-button animated unicampFadeInUp"
                          data-id="767d1e4"
                          data-element_type="widget"
                          data-settings='{"_animation":"unicampFadeInUp"}'
                          data-widget_type="tm-button.default"
                ...
                <div className="elementor-row">
                  ...
                  >
                    <div className="elementor-column-wrap elementor-element-populated">
                      <div className="elementor-widget-wrap">
                        <div
                          className="elementor-element elementor-element-9776cad unicamp-animation-zoom-in bullets-v-align-below elementor-widget elementor-widget-tm-event-carousel animated unicampFadeInUp"
                          data-id="9776cad"
                          data-element_type="widget"
                          data-settings='{"_animation":"unicampFadeInUp"}'
                                ...
                                <div className="swiper-container swiper-container-initialized swiper-container-horizontal">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <Link href="https://portal.scitech.au.edu/idl/">
                                      <img
                                              src="https://raw.githubusercontent.com/u6016901/vms2022.github.io/main/pictures/blog-15-480x320.jpg"
                                              width={480}
                                            />
            ...
            <div className="wooscp-popup-content-inner">
              ...
              <ul className="wooscp-settings-fields">
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="image" defaultChecked="" />
                  <span className="label">Image</span>
                </li>
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="sku" defaultChecked="" />
                  <span className="label">SKU</span>
                </li>
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="rating" defaultChecked="" />
                  <span className="label">Rating</span>
                </li>
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="price" defaultChecked="" />
                  <span className="label">Price</span>
                </li>
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="stock" defaultChecked="" />
                ...
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="content" defaultChecked="" />
                  <span className="label">Content</span>
                </li>
                <li className="wooscp-settings-field-li">
                  <input type="checkbox" className="wooscp-settings-field" defaultValue="weight" defaultChecked="" />
      ...
      >
        <div className="wooscp-inner">
          <div className="wooscp-table" style={{ backgroundColor: "rgb(41, 42, 48)" }}>
          ...
          <div className="wooscp-bar " data-count={0} style={{ backgroundColor: "rgb(41, 42, 48)" }}>
            <div className="wooscp-bar-notice">Click outside to hide the compare bar </div>
            <a href="javascript:void(0);" className="wooscp-bar-settings hint--top" aria-label="Select fields" />
            <a href="javascript:void(0);" className="wooscp-bar-search hint--top" aria-label="Add product" />
            <div className="wooscp-bar-items" />
            <div className="wooscp-bar-btn wooscp-bar-btn-text" style={{ backgroundColor: "rgb(174, 21, 45)" }}>
              ...
              <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-45 level-1">
                ...
                <ul className="sub-menu children simple-menu">
                  ...
                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1066">
                    <link href="https://portal.scitech.au.edu/idl/" />
                    <div className="menu-item-wrap">
                      <span className="menu-item-title">Intelligent Data Analytics Research Laboratory</span>
                    </div>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1481">
                    <link href="https://portal.scitech.au.edu/dcode/" />
